	...
	render(){
		...
		return(
	        ...
	        <ScrollView
	            ...
	            {(!thisChat || !this.state.user.id) &&
	      	        <Text style={styles.noMessages}>
                        Send a message to start chatting with {this.state.user.username}!
                    </Text>
	            }
	        </ScrollView>
	        <View style={styles.textBox}>
		        ...
		        <TextInput autoCapitalize="sentences" style={styles.input} onChangeText={(text) => this.setState({message: text})}
